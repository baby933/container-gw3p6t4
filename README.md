...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gw3p6t4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gw3p6t4.containers.anotherwebservice.com/
...
```
git clone git@github.com:baby933/container-gw3p6t4.git
cd container-gw3p6t4
```
...
```
docker attach container-gw3p6t4
```
